...
| pionex-earn-dual                                                                                                  | 双向理财：查产品、申购、撤单、收益提取       | 部分 |

### CLI

**`pionex-trade-cli`** —— 通过命令行直接访问 Pionex 行情、账户、订单、合约网格机器人与双向理财
...
在 AI 客户端中输入：*"用 Pionex MCP 工具，查询投入 USDT、到期价格跌破行权价时获得 BTC 的双向理财产品，列出可申购的行权价及当前收益率。"*
...
在 AI 客户端中输入：*"用 Pionex Skills，查询投入 USDT、到期价格跌破行权价时获得 BTC 的双向理财产品，列出可申购的行权价及当前收益率。"*

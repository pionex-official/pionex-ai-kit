...
| pionex-earn-dual                                                                                                  | 雙向理財：查產品、申購、撤單、收益提取       | 部分 |

### CLI

**`pionex-trade-cli`** —— 透過命令列直接存取 Pionex 行情、帳戶、訂單、合約網格機器人與雙向理財
...
在 AI 用戶端中輸入：*"用 Pionex MCP 工具，查詢投入 USDT、到期價格跌破履約價時獲得 BTC 的雙向理財產品，列出可申購的履約價及當前收益率。"*
...
在 AI 用戶端中輸入：*"用 Pionex Skills，查詢投入 USDT、到期價格跌破履約價時獲得 BTC 的雙向理財產品，列出可申購的履約價及當前收益率。"*
